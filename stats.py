...
if __name__ == "__main__":
	...
	a1 = chess_agents.AlphaBetaAgent(color=chess.WHITE, eval_func=counter.weighted_piece_count, depth='1')
	a2 = chess_agents.AlphaBetaAgent(color=chess.BLACK, eval_func=counter.weighted_piece_count, depth='1')
	board = losing_board.LosingBoard(no_kings=False)

	s = StatsGenerator()
	s.compare_agents(a1, a2, board, 20)
